                ...
                builder: (context, snapshot) {
                  if(snapshot.hasData){
                    return Expanded(
                      child: GridView.builder(
                          ...
                          itemBuilder: (context, index) {
                            return  InkWell(
                              onTap : (){
                                Navigator.push(context, MaterialPageRoute(builder: (context) => Itemfeed(category: snapshot.data![index].strCategory,image: snapshot.data![index].strCategoryThumb,)));
                              },
                    ...
                    return Center(
                      heightFactor: 10,
                      child: TextButton(
                        child: const Text("Refresh"), onPressed: () {
                        setState(() {
